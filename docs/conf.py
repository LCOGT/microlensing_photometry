...
project = "microlensing_photometry"
copyright = "2024, Rachel Street, Etienne Bachelet"
author = "Rachel Street, Etienne Bachelet"
release = version("microlensing_photometry")
